...
public struct PanelPresentation: Sendable, Equatable {
    ...
    public init(semantic: PanelSemanticState, title: String?, message: String?,
...
public enum UIStatePolicy {
    public static func presentation(engineCompleteness: EngineResultCompleteness,
                                    flowStatus: FlowOutcomeStatus,
                                    insertion: InsertionOutcome) -> PanelPresentation {
        ...
        case .partial:
            return PanelPresentation(semantic: .warning,
        ...
        case .degraded:
            return PanelPresentation(semantic: .error,
        ...
        case .verifiedInserted:
            return PanelPresentation(semantic: .verifiedSuccess,
                                     title: "Inserted",
                                     message: nil,
        ...
        case .eventPostedUnverified:
            ...
            return PanelPresentation(semantic: .unverifiedPosted,
                                     ...
                                     symbol: "paperplane")
        case .targetChanged:
            return PanelPresentation(semantic: .review,
        ...
        case .deadlineExceeded:
            return PanelPresentation(semantic: .warning,
                                     ...
                                     symbol: "timer")
        case .cancelled:
            return PanelPresentation(semantic: .neutral,
                                     title: "Cancelled",
                                     message: nil,
    ...
    public static func isVerifiedSuccess(engineCompleteness: EngineResultCompleteness,
                                         flowStatus: FlowOutcomeStatus,
                                         insertion: InsertionOutcome) -> Bool {
        presentation(engineCompleteness: engineCompleteness,
                     flowStatus: flowStatus,
                     insertion: insertion).semantic == .verifiedSuccess
    }
}
