...
SUITES = ["M0ContractTests", "ProductionBlockerTests", "FlowProcessorTests", "ModelsTests",
          ...
          "ProductionPreparationTests", "ProductionAcquisitionTests", "ProductionPasteboardTests", "ProductionHistoryTests", "FlowDeadlineTests", "ProductionSettingsTests", "ProductionFnPreferenceTests"]
