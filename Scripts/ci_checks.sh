...
if run_logged xctest-discovery swift test list; then
  for suite in M0ContractTests ProductionBlockerTests FlowProcessorTests ModelsTests \
      ...
      ProductionPreparationTests ProductionAcquisitionTests ProductionPasteboardTests ProductionHistoryTests FlowDeadlineTests ProductionSettingsTests ProductionFnPreferenceTests ProductionAdmissionTests AxBoundedRunnerTests ProductionTargetReadTests LongDictationTests ProductionChunkDecodeTests; do
